...
//funcao que conta nos folhas = basta chamar a funcao que conta o numero de nos e adicionar + 1

//ou vice-versa -> funcao que conta numero de nos: basta chamar a funcao conta nos folhas e subtrair -1
