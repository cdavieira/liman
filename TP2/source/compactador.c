...
#include <stdlib.h>
#include <string.h>
#define ascii_char_set 128 //consiste no tamanho do vetor onde serão armazenadas as ocorrencias dos caracteres ASCII. Em outras palavras, corresponde ao conjunto total de caracteres ASCII que devem ser considerados no mapeamento (padrão 128)
