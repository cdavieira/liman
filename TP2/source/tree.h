...
/*  testar_nodulo_folha
    Descrição: testa se a árvore fornecida pode ser um nó ou não
...
/*  ir_ate_nodulo
    ...
    Output: caso suceda retorna o nódulo encontrado após seguir as isntruções contidas na rota, caso contrário retorna nulo
