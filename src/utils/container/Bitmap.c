...
unsigned char *
bitmapGetContents(const Bitmap *bm)
{
  return bm->contents;
}

unsigned int
bitmapGetMaxSize(const Bitmap *bm)
{
  return bm->max_size;
}

unsigned int
bitmapGetLength(const Bitmap *bm)
{
  return bm->length;
}

Bitmap *
bitmapInit(unsigned int max_size)
{
  Bitmap *bm;
...
static void
bitmapSetBit(Bitmap *bm, unsigned int index, unsigned char bit)
{
...
void
bitmapAppendLeastSignificantBit(Bitmap *bm, unsigned char bit)
{
  bm->length++;
...
void
bitmapPrint(const Bitmap *bm, FILE *fpout)
{
...
void
bitmapDump(Bitmap *bm, FILE *fpout)
{
...
void
bitmapConcat(Bitmap *dest, const Bitmap *source)
{
