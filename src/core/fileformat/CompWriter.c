...
CompWriter *
compWriter_from_huffmanTree(HuffmanTree *ht)
{
...
CompWriter *
compWriter_destroy(CompWriter *writer)
{
...
void
compWriter_set_inputfile(CompWriter *writer, const char *inputfile)
{
...
compWriter_get_statistics(CompWriter *writer)
{
...
size_t
compWriter_get_total_compressed_size_in_bytes(CompWriter *writer)
{
...
size_t
compWriter_get_total_uncompressed_size_in_bytes(CompWriter *writer)
{
  if (writer->inputfile == NULL)
  {
    return 0;
...
float
compWriter_get_compression_rate(CompWriter *writer)
{
  return compWriter_get_statistics(writer).compression_rate;
}

void
compWriter_dump(CompWriter *writer, const char *outputfile)
{
