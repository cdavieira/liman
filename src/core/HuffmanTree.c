...
HuffmanTree *
huffmanTree_new(unsigned int key,
                unsigned long weight,
                HuffmanTree *left,
                HuffmanTree *right)
{
  return (HuffmanTree *)tree_new(
      (void *)huffmanCode_new(key, weight), (Tree *)left, (Tree *)right);
}

HuffmanTree *
huffmanTree_destroy(HuffmanTree *hftree)
{
  return hftree ? (HuffmanTree *)tree_destroy(
                      (Tree *)hftree, (void *(*)(void *))huffmanCode_destroy)
                : 0;
}

size_t
huffmanTree_get_id(HuffmanTree *node)
{
  return tree_get_id((Tree *)node);
}

unsigned int
huffmanTree_get_key(HuffmanTree *node)
{
  return huffmanCode_get_key((HuffmanCode *)tree_get_item((Tree *)node));
}

unsigned long
huffmanTree_get_weight(HuffmanTree *node)
{
  return huffmanCode_get_weight((HuffmanCode *)tree_get_item((Tree *)node));
}

HuffmanTree *
huffmanTree_get_left(HuffmanTree *hftree)
{
  return (HuffmanTree *)tree_get_left((Tree *)hftree);
}

HuffmanTree *
huffmanTree_get_right(HuffmanTree *hftree)
{
  return (HuffmanTree *)tree_get_right((Tree *)hftree);
}

Code
huffmanTree_get_code(HuffmanTree *hftree)
{
  return huffmanCode_get_value(tree_get_item((Tree *)hftree));
}

HuffmanCode *
huffmanTree_get_value(HuffmanTree *hftree)
{
  return tree_get_item((Tree *)hftree);
}

HuffmanTree *
huffmanTree_get_child(HuffmanTree *hftree, unsigned lr)
{
  return (HuffmanTree *)tree_get_child((Tree *)hftree, lr);
}

HuffmanTree *
huffmanTree_set_left(HuffmanTree *hftree, HuffmanTree *filho)
{
  return (HuffmanTree *)tree_set_left((Tree *)hftree, (Tree *)filho);
}

HuffmanTree *
huffmanTree_set_right(HuffmanTree *hftree, HuffmanTree *filho)
{
  return (HuffmanTree *)tree_set_right((Tree *)hftree, (Tree *)filho);
}

unsigned
huffmanTree_is_leaf(HuffmanTree *hftree)
{
  return tree_is_leaf((Tree *)hftree);
}

unsigned long
huffmanTree_get_count(HuffmanTree *hftree)
{
  return tree_get_count((Tree *)hftree);
}

unsigned long
huffmanTree_get_height(HuffmanTree *hftree)
{
  return tree_get_height((Tree *)hftree);
}

unsigned long
huffmanTree_get_leaf_count(HuffmanTree *hftree)
{
  return tree_get_leaf_count((Tree *)hftree);
}

static void
gencodes_callback(Tree *t, unsigned height, unsigned long path)
{
...
void
huffmanTree_gencodes(HuffmanTree *root)
{
  tree_visit_leafs((Tree *)root, gencodes_callback);
}

static unsigned
huffman_compare_key(void *hufftree1, void *ascii)
{
...
HuffmanTree *
huffmanTree_search_key(HuffmanTree *hftree, unsigned key)
{
  return (HuffmanTree *)tree_search(
      (Tree *)hftree, (void *)&key, huffman_compare_key);
}

static unsigned long
huffmanTree_get_msg_size_rec(HuffmanTree *hftree, unsigned long height)
{
  if (!hftree)
  {
    return 0;
...
unsigned long
huffmanTree_get_msg_size(HuffmanTree *hftree)
{
  return huffmanTree_get_msg_size_rec(hftree, 0);
}

int
huffmanTree_compare_freq(HuffmanTree *map1, HuffmanTree *map2)
{
  return huffmanTree_get_weight(map1) > huffmanTree_get_weight(map2);
}

static void
huffmanTree_printfp_labels(HuffmanTree *node, FILE *fp)
{
  if (!node)
  {
    return;
...
static void
huffmanTree_printfp_arrows(HuffmanTree *node, FILE *fp)
{
  if (!node)
  {
    return;
...
void
huffmanTree_printfp_dot(HuffmanTree *root, FILE *fp)
{
  fprintf(fp,
          "digraph Tree {\n"
          "    node [fontname=\"Arial\"];\n");
...
void
huffmanTree_printfp_codes(HuffmanTree *hufftree, FILE *fp)
{
  HuffmanTree *t;
