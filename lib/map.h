...
/*  calcular_tamanho_bits_mapa
    Descrição: calcula o tamanho necessario em bits para representar a mensagem do mapa 
    
    Input: mapa
    
    Output: número inteiro (unsigned long) necessário para representar a mensagem do mapa
...
/*  comparar_pesos_mapa
    Descrição: compara se o peso do mapa 1 é superior ou igual ao do mapa 2
    
    Input: dois mapas a serem comparados
