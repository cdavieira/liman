...
/*  adicionar_ordenadamente_listaCircular
    Descrição: adiciona um elemento em um indice da lista circular, de forma que fique ordenada

    Detalhes:
    Caso seja fornecido um indice positivo maior do que o numero atual de elementos e menor do que o número máximo de elementos, o elemento é adicionado ao final da lista circular

    Input: lista circular a ser modificada, item a ser adicionado e função booleana que compara os elementos contidos na lista e o elemento a ser adicionado
    
    Output: lista ordenada com item adicionado
    
    Pré condição: argumentos não nulos, lista previamente ordenada
