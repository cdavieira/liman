...
/*  adicionar_ordenadamente_listaArvores
	Descrição: adiciona um mapa em um indice da lista de arvores, de forma que fique ordenada
	...
	Input: lista de arvores a ser modificada, mapa a ser adicionado e função booleana que compara os mapas contidos na lista e o mapa a ser adicionado
	
	Output: lista ordenada com mapa adicionado
